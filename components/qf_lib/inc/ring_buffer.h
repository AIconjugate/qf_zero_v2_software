...
#define ring_buffer_compile_en 0 // 库编译时能

#if ring_buffer_compile_en

// 一下任意功能不需要时关闭都可以提升性能
#define ring_buffer_moving_flitering_en 1 // 滑动滤波功能使能
#define ring_buffer_suppot_unsigned 0     // 支持无符号型数据使能
#define ring_buffer_suppot_signed 1       // 支持有符号型数据使能
...
#define ring_buffer_suppot_float 1        // 支持浮点型数据使能
