...
#define cw2015_lib_compile 1

#if cw2015_lib_compile

#define CW2015_ADDR 0x62

#define CW_DEBUG 0          // 调试输出信息,1:启用，0：禁用
#define CW_DEBUG_OUT printf // 调试输出信息的打印函数名，如是自定义的需在上面包含头文件或声明
    ...
    enum
    {
        cw2015_rtt_max = 8191 // 预估可用时长超出最大量程
    };
